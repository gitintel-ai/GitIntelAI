...
claude --model claude-opus-4-5 \
  ...
  -p "You are the lead architect for GitIntel AI. 
      ...
      Spawn sub-agents to implement each task group in TASKS.md.
      Coordinate via shared TASKS.md status updates.
...
**Context:** specs/01-cli-core.md, ARCHITECTURE.md
**Deliverables:**
...
**Context:** specs/03-cost-engine.md, ARCHITECTURE.md
**Deliverables:**
...
**Context:** specs/04-context-manager.md, ARCHITECTURE.md
**Deliverables:**
...
**Context:** specs/05-dashboard.md, ARCHITECTURE.md
**Deliverables:**
