      ...
      <div className="prose prose-neutral dark:prose-invert mt-10 max-w-none space-y-8">
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            ) is free and open source software released under the{" "}
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            is subject to these terms. By creating an account, you agree to:
          </p>
          <ul className="mt-3 space-y-2 text-muted-foreground">
            ...
            <li>
              Not use the service to store or transmit source code that you do
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            You may not use GitIntel AI to:
          </p>
          <ul className="mt-3 space-y-2 text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            . The CLI operates entirely locally; no data leaves your machine
            unless you configure cloud sync.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            We provide the hosted service on an &ldquo;as is&rdquo; basis. We
            do not guarantee uptime or availability. The open-source CLI is
            fully functional offline and is not dependent on the hosted service.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            To the maximum extent permitted by law, GitIntel AI and its
            contributors are not liable for any indirect, incidental, special,
            consequential, or punitive damages arising from your use of the
            software or service. The CLI is provided under the MIT License,
            which disclaims all warranties.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            hosted service after changes take effect constitutes acceptance of
            the revised Terms.
          </p>
        </section>
